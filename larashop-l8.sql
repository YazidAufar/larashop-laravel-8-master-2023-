...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 19, 2023 at 08:15 AM
...
(1, 'The Book I', 'the-book', 'Description about the book', 'Yazid Aufar', 'Indie', 'book-covers/BRc9LVpDzOZ9sqMnO0luw5mn7um5hNlIx2Hcsv3l.png', 199000.00, 0.50, 0, 190, 'PUBLISH', 1, 1, NULL, '2020-12-15 02:22:07', '2023-05-22 18:40:48', NULL),
(2, 'How to be Ninja Developer', 'how-to-be-ninja-developer', 'The description baru buku dari saya', 'Yazid Aufar', 'Indie', 'book-covers/wXrM5IbXJC40u6yWBitJ7uyrUPk5T2w9SnwzmNaX.jpg', 299000.00, 0.50, 0, 1, 'PUBLISH', 1, 1, NULL, '2020-12-15 03:44:34', '2023-05-22 18:41:00', NULL),
(4, 'How to be Rockstar Developer', 'how-to-be-rockstar-developer', 'The description about the book', 'Yazid Aufar', 'Indie', 'book-covers/VvuisuN0KZDOuyovClGAeJb7yHgkKmtZqGH3gzqi.jpg', 290000.00, 0.50, 0, 99, 'PUBLISH', 1, 1, NULL, '2020-12-15 03:46:40', '2023-05-22 18:41:09', NULL);
...
(13, '2023_06_06_024346_create_provinces_table', 8),
(14, '2023_06_06_024507_create_cities_table', 8),
(15, '2023_06_12_041105_adds_api_token_to_users_table', 9),
(16, '2023_06_12_042238_adds_api_token_to_users_table', 10);
...
CREATE TABLE `orders` (
  ...
  `courier_service` varchar(13) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
(1, 4, 299000.00, '202012140001', NULL, 'FINISH', '2020-12-12 11:01:50', NULL),
(2, 5, 580000.00, '202012250002', NULL, 'PROCESS', '2020-12-25 11:01:57', NULL);
...
INSERT INTO `users` (`id`, `name`, `email`, `email_verified_at`, `password`, `remember_token`, `username`, `roles`, `address`, `city_id`, `province_id`, `phone`, `avatar`, `status`, `created_at`, `updated_at`, `api_token`) VALUES
(1, 'Yazid Aufar', 'administrator@larashop.test', NULL, '$2y$10$bVkzcLNUybkPB/87HSAhAundk.pqAv3u8t4jPeEX96ucKL9BR92hO', NULL, 'administrator', '[\"ADMIN\"]', 'Sarmili, Bintaro, Tangerang Selatan', 0, 0, '085242264566', 'avatars/AanL5J0f2DXzVlWgo1xgSzvkhpLUBFkXezDHdp5o.jpg', 'ACTIVE', '2020-12-14 02:29:07', '2023-06-18 20:31:21', 'yKw5pXZL4KT2yxC2DPc9Tk8s7cAv28adaKTcY6Crm1lgqcHK6tK2iKxsyccP'),
(4, 'Nadia', 'nadia.nm@gmail.com', NULL, '$2y$10$C3TgyddwCXcoca.m676Y9Osm//Qdc91FmK2nG8/3d9JULdEEYTOSq', NULL, 'nadia.nm', '[\"CUSTOMER\"]', 'Desa Panangkalaan Hilir No. 036 RT. 03, Kec. Amuntai Utara, Kabupaten Hulu Sungai Utara', 0, 0, '085242264566', 'avatars/cw4FApgtVcGejt7GPL9tFAZvFyfLSdW8EUv1JMAe.jpg', 'ACTIVE', '2020-12-15 03:48:42', '2023-05-22 18:33:00', NULL),
(5, 'Johan Z D', 'johan.zd@gmail.com', NULL, '$2y$10$AKuoCook1Fuka8x10TyZwuLpxV4kB2I0JXPyFE0cpfQsqjgZQ1Pji', NULL, 'johan.zd', '[\"CUSTOMER\"]', 'Banjarbaru Kalimantan Selatan', 0, 0, '08578110744', 'avatars/fWg9E4Zei9Z6Q4tX63lSqgOSlnP5T97hCpm4youb.jpg', 'ACTIVE', '2020-12-15 03:49:51', '2023-05-22 18:33:47', NULL),
(6, 'stafbaru', 'staff@larashop.test', NULL, '$2y$10$bRaD4IwCIAbXZ4iRD.XhrezFBZCtkc.354kQ0Kf6Xjvj2V6q4LWky', NULL, 'stafbaru', '[\"on\"]', 'Alamat baru untuk staf', 0, 0, '085242264577', 'avatars/aTNT3rJZdlEBbRFvnx2Nby8Kp3lIy999NmUZbzsX.png', 'ACTIVE', '2023-05-22 18:54:10', '2023-05-22 18:54:10', NULL);
